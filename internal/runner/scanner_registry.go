	...
	return []ScannerAdapter{
		...
		scannerAdapter{
			...
			info: ScannerInfo{
				...
				Description:   "Local file or directory scanner invoked through skill-scanner with JSON report output.",
			},
			installPlan: InstallPlan{
				ScannerID:        "cisco",
		...
		scannerAdapter{
			...
			info: ScannerInfo{
				...
				OptionalEnv:   []string{"OPENAI_API_KEY", "ANTHROPIC_API_KEY", "NVIDIA_INFERENCE_KEY", "SKILLSPECTOR_PROVIDER"},
			},
			installPlan: InstallPlan{
